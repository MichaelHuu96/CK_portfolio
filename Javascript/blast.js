...
$(".blast_container h1").blast({
  delimiter: "character",
  tag: "span"
});

a = 0;
$(".blast_container .blast").each(function() {
  if (a == 300) {
    a = 400;
  }
  ...
  if (a == 400) {
    setTimeout(function() {
      $(".blast_container h1 img").addClass("animated rotateIn");
    }, 500);
  }
...
setTimeout(function() {
  $(".blast_container .blast").removeClass("animated bounceIn");
  $(".blast_container .blast").css("opacity", 1);

  $(".blast_container .blast").mouseenter(function() {
    var el = $(this);
...
setTimeout(function() {
  $(".blast_container .flat-button").addClass("animated bounceIn");
  $(
    ".blast_container .flat-button"
  ).one(
    "webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend",
    function() {
      $(".blast_container .flat-button").removeClass("animated bounceIn");
      $(".blast_container .flat-button").css("opacity", 1);
    }
  );
}, 2000);

$(".blast_container .flat-button").mouseenter(function() {
  var el = $(this);
